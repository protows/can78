    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               ...
               <!--  <div class="i_con">
                    <ul class="nav navbar-nav text-uppercase">
                        <li><a href="<?php //echo Yii::getAlias('@web') . "/site/login" ?> ">Login</a></li>
                        <li><a href="<?php //echo Yii::getAlias('@web') . "/site/signup" ?>">Register</a></li>
                    </ul>
                </div> -->
                 <div class="i_con">
                    <ul class="nav navbar-nav text-uppercase">
...
<footer class="footer-widget-section">
                ...
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        ...
                        <div>
                            ...
                            <span class="p-date">March 30, 2019</span>
                        </div>
                    </div>
                </aside>
            </div>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2019 <a href="#">be PRO, </a> Built with <i
                            class="fa fa-heart"></i> by <a href="#">Miner</a>
                    </div>
                </div>
            </div>
        </div>
